...
from .views import  admin_dashboard, user_list,dep_list, admin_list,dep,register_user,UserLogoutView,register_admin
# from knox import views as knox_views
from .views import  admin_dashboard, user_list,login_view, admin_list,dep,register_user,UserLogoutView,register_admin,IsAdmin,IsUser
from django.urls import path
